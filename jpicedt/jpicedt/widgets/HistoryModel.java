 ...
 * fields.
 * @author Slava Pestov
 * @version $Id: HistoryModel.java,v 1.4 2006/07/18 16:02:22 reynal Exp $
 *
 */
public class HistoryModel {
	...
	public HistoryModel(String name) {
		...
		// 		try {max = Integer.parseInt(jEdit.getProperty("history"));}
		// 		catch(NumberFormatException nf){max = 25;}
		max = 25;
	...
	public static HistoryModel getModel(String name) {
		if(models == null)
			models = new Hashtable<String,HistoryModel>();
