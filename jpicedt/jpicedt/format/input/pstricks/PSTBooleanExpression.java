// PSTBooleanExpression.java --- -*- coding: iso-8859-1 -*-
...
//
// Version: $Id: PSTBooleanExpression.java,v 1.9 2013/03/31 06:55:39 vincentb1 Exp $
// Keywords: parser
...
public class PSTBooleanExpression extends SequenceExpression {
     ...
     * @param tag LHS tag (e.g. "shadow" or "doubleline") for the StatementExpression ;
     ...
     */
    public PSTBooleanExpression(Pool pl, String tag, PicAttributeName<Boolean> attributeName, Pool.Key<PicAttributeSet> attributeSetKey){
		...
		add(new LiteralExpression(tag + "="));
		add(new AlternateExpression(
			new LiteralExpression("true"){
				public void action(ParserEvent e){
					if (DEBUG) System.out.println(e);
					pool.setAttribute(setKey,attribute, new Boolean(true));
			}},
			new LiteralExpression("false"){
				public void action(ParserEvent e){
					if (DEBUG) System.out.println(e);
					pool.setAttribute(setKey,attribute, new Boolean(false));}}));
	}
