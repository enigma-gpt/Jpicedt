// OptionalExpression.java --- -*- coding: iso-8859-1 -*-
...
//
// Version: $Id: OptionalExpression.java,v 1.7 2013/03/31 06:59:14 vincentb1 Exp $
// Keywords: parser
...
public class OptionalExpression extends AbstractRegularExpression {
    ...
    /**
     * @return TRUE in any case since this expression is... optional !
     */
    public boolean interpret(Context c) throws REParserException {

		boolean b = expr.interpret(c);
		action(new ParserEvent(this, c, b, new Boolean(b)));
		return true;
    }
