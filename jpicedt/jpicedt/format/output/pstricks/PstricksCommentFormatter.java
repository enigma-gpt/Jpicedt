 ...
 * @since jPicEdt 1.6
 */
public class PstricksCommentFormatter
	extends TeXCommentFormatter
{
	public PstricksCommentFormatter(FormatterFactory factory) {
		super(factory);
	...
	public String getConcreteContentType() {
		return new PstricksContentType().getPresentationName();
	}
}