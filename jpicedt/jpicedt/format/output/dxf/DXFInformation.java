...
/**
 * Interface offerte par tout élément d'un patron de document DXF (marque déposée).
 * @since jPicEdt 1.6
 */
interface DXFInformation
{
	/**
	 * Formatte une information donnée d'un document DXF (marque déposée) telle qu'on peut la
	 * lire dans un patron de document DXF (marque déposée)
	 * @since jPicEdt 1.6
	 */
