/*
 DefaultViewFactory.java - February 9, 2002 - jPicEdt, a picture editor for LaTeX.
...
public class PicNodeConnectionView extends LeafElementView {
	 ...
	 */
	public PicNodeConnectionView(PicNodeConnection edge, AttributesViewFactory f){
		super(edge,f);
		changedUpdate(null);
	}

	public PicNodeConnection getElement(){
		return (PicNodeConnection)element;
	}
