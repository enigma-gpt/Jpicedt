// UserDataLine.java --- -*- coding: iso-8859-1 -*-
// Copyright 2009/2011 Vincent Belaïche
//
// Author: Vincent Belaïche <vincentb1@users.sourceforge.net>
// Version: $Id: UserDataLine.java,v 1.4 2013/03/27 07:03:34 vincentb1 Exp $
// Keywords:
...
/**
 * Ligne de donnée utilisateur extraite d'un fichier ayant un format de
 * sauvegarde jPicEdt
...
public abstract class UserDataLine{
	...
	public UserDataLine(String userDataLine){
		this.userDataLine = userDataLine;
	}
	public void write(CommentFormatting cf) throws java.io.IOException{
		cf.weakCommentFormat(userDataLine);
	}

	public String toString(){ return userDataLine; }
};


/// UserDataLine.java ends here
